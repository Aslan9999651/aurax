    ...
    <div>
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 lg:px-6 py-16 lg:py-24 grid lg:grid-cols-2 gap-10 items-center">
          <div className="fade-up">
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              {user ? (
                <>
                  <Link to="/spot" data-testid="hero-spot-btn" className="px-6 py-3 rounded-xl font-semibold btn-cyan flex items-center gap-2">التداول الفوري الآن <ArrowLeft size={18} /></Link>
                  <Link to="/wallet" data-testid="hero-wallet-btn" className="px-6 py-3 rounded-xl font-semibold bg-[var(--ax-s2)] hover:bg-[var(--ax-s3)]">إدارة المحفظة</Link>
                </>
              ) : (
                <>
      ...
      <section className="max-w-[1400px] mx-auto px-4 lg:px-6 pb-16">
        {!user ? (
          ...
          <div className="panel p-8 lg:p-12 text-center glow-cyan" style={{ background: "linear-gradient(135deg,rgba(0,229,255,0.08),rgba(0,229,255,0.02))" }}>
